...
public class CategoryDAO {
	...
	public void save(Category object) {
		...
		for (String categoryElement : object.getTagList()) {

			String sql = "INSERT INTO CATEGORY (USER_ID, NAME) VALUES (?,?)";
			Object[] params = { object.getUser().getId(), categoryElement };
	...
	public void updateCategory(Category object) {
		...
		Object[] params = { object.getTagList(), object.getId() };
		int rows = jdbcTemplate.update(sql, params);
		LOGGER.setLevel(Level.INFO);
	...
	static Category convert(ResultSet rs) throws SQLException {
		...
		object.setUser(user);
		object.setTagList(Arrays.asList(rs.getString("NAME")));
		return object;
	}
}
